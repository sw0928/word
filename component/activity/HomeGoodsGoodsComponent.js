...
class HomeLabelComponent extends  BaseComponent{
    ...
    getHomeGoods(){
        this.getDataByPost(1,homeurl+"activityController.api?getHomeGoods",{parent_id:this.props.params.parent_id});
    }
                ...
                <div style={{display:'flex',justifyContent:'flex-end',marginTop:20,alignItems:'center'}}>
                    <Widget.Button
                        ...
                        onClick={()=>{
                            ...
                            encodeURIComponent(JSON.stringify({goods_type:"goods",parent_id:this.props.params.parent_id})));
                        }}>
