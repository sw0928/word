                ...
                <form style={{position:'absolute',top:'50%',left:'50%',transform:'translate(-50%, -50%)'}}>
                    <div className="form-group">
                        <label 
                         ...
                         style={{color:'#fff',fontSize:'16px',display:'bolck',paddingLeft:'86px'}}>用户</label>
                        <input  style={{width:'200px'}}
                        type="email" className='form-control'  id="exampleInputEmail1" placeholder="账号"
                               onChange={(e)=>{
                                           this.setState({
                    ...
                    <div class="form-group">
                        ...
                        style={{color:'#fff',fontSize:'16px',display:'bolck',paddingLeft:'86px'}}>密码</label>
                        <input style={{width:'200px'}}
                        type="password" className='form-control'  id="exampleInputPassword1" placeholder="密码"
                            onChange={(e)=>{
                                             this.setState({
