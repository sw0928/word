...
class SystemMoudleComponent extends BaseComponent{
    // 构造
    constructor(props) {
        super(props);
        // 初始状态
                        ...
                        return(
                            <div style={{display:'flex',flex:1}}>
                                    <div style={{display:'flex',flex:1,flexDirection:'row',alignItems:'center',justifyContent:'center'}}>
                                        <Link to={"/system_moudle_2/"+this.state.moduleBeans[rowID].moudle_id+"/"+(parseInt(this.state.level)+1)}
                                            style={{textDecoration:'none'}}>
...
module.exports=SystemMoudleComponent;
