...
var Member1Component=require('./Member1Component');
...
class  MemberDetailComponent extends BaseComponent{
    ...
    render(){
        return(
            <div>
                <Toolbar title={this.state.count==="1"?"用户详情":(this.state.count+"级分销详情")} history={this.props.history}></Toolbar>
    ...
    renderMember() {
        return (
            <Member1Component count={this.state.count} type="1" member_id={this.state.member_id}></Member1Component>
        );
    }
    renderBase(){
        return(
