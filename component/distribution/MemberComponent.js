    ...
    render(){
        return(
            <div style={{background:'#ffffff',flex:1,height:'100%'}}>
                ...
                <Toolbar title="用户管理" history={this.props.history}></Toolbar>
                        ...
                        return(
                            <div style={{display:'flex',flex:1}}>
                                    <div style={{display:'flex',flex:1,flexDirection:'row',alignItems:'center',justifyContent:'center'}}>
                                        <Link to={"/distribution_member_detail/"+encodeURIComponent(JSON.stringify(this.state.memberBeans[rowID].member_id))+"/1"}
