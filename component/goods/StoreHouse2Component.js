...
class RecipeComponent extends BaseComponent{
    ...
    getGoodsStorehouses(page){
        this.getDataByPost(1,homeurl+"goodsController.api?getGoodsStorehouses2",
            {page:page},{type:2})
    }
    ...
    render(){
        return(
            <div style={{background:'#ffffff',display:'flex',flexDirection:'column'}}>
                ...
                <Toolbar title="网点管理" history={this.props.history}></Toolbar>
                <ListViewComponent
                    data={[{name:"ID",flex:1,key:'storehouse_id'},
                            {name:"网点名",flex:1,key:'storehouse_name'},
                            {name:"省/直辖市",flex:1,key:'storehouse_province'},
                            {name:"市/区",flex:1,key:'storehouse_city'},
                            {name:"详细地址",flex:1,key:'storehouse_area'},
                            {name:"联系人姓名",flex:1,key:'contact_name'},
                    ...
                    renderAdd={()=>{
                        return(
                            <LinkComponent
                                    ...
                                    to={"/goods_storehouse_editor2/"+encodeURIComponent(JSON.stringify({}))}
                                    value="添加"/>
                        )
                    }}
                        ...
                        return(
                            <div style={{display:'flex',flex:1}}>
                                    <div style={{display:'flex',flex:1,flexDirection:'row',alignItems:'center',justifyContent:'center'}}>
                                        <Link to={"/goods_storehouse_editor2/"+encodeURIComponent(JSON.stringify(this.state.storehouseBeans[rowID]))}
