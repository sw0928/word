...
class InformationClassComponent extends BaseComponent{
    // 构造
    constructor(props) {
        super(props);
        // 初始状态
    ...
    getInformations(page){
        this.getDataByPost(1,homeurl+"informationController.api?getInformations"
            ,{parent_id:"-1",information_type:'1',page:page},{type:2})
    }
                    ...
                    renderAdd={()=>{
                        return(
                            <LinkComponent
                                    ...
                                    to={"/information_editor/"+encodeURIComponent(JSON.stringify({parent_id:"-1",information_type:'1'}))}
                                    value="添加"/>
                        ...
                        return(
                            <div style={{display:'flex',flex:1}}>
                                ...
                                <div style={{display:'flex',flex:1,flexDirection:'row',alignItems:'center',justifyContent:'center'}}>
                                    <Link to={"/information/"+this.state.informationBeans[rowID].information_id}
                                            style={{textDecoration:'none'}}>
                                        <p1 style={{fontSize:13}}>[知识列表]</p1>
                                    </Link>
                                </div>
...
module.exports=InformationClassComponent;
