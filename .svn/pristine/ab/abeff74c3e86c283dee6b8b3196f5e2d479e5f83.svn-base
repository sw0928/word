...
class InboundComponent extends BaseComponent{
    ...
    addLogistics(){
        ...
        this.getDataByPost(2,homeurl+"orderController.api?insertLogisticsInfo",
            {logistics_no:this.state.logistics_no,city:merchantsAccountBean.city,storehouse_id:merchantsAccountBean.storehouse_id,storehouse_name:merchantsAccountBean.storehouse_name,type:'sign'});
    }
