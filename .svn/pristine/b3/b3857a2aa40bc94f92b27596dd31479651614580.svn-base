...
/**
 * Created by sjb on 2016/3/24.
 */
public class RecyclerViewAutoRefreshUpgraded extends RecyclerView {
    ...
    public final static int TYPE_headerView = 5;
    public final static int TYPE_FOOTERView = 6;
    ...
    public RecyclerViewAutoRefreshUpgraded(Context context) {
        super(context);
        this.context = context;
        init();
    }

    public RecyclerViewAutoRefreshUpgraded(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init();
    }

    public RecyclerViewAutoRefreshUpgraded(Context context, AttributeSet attrs, int defStyle) {
    ...
    public class AutoLoadAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public int getItemViewType(int position) {
            ...
            if (addHeaderView != null && position == 1) {
                return TYPE_headerView;
            }
            if (addFooterView != null && position == getItemCount() - 2) {
            ...
            if (getLayoutManager() instanceof LinearLayoutManager) {
                return mInternalAdapter.getItemViewType(addHeaderView == null ? position - 1 : position - 2);
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == TYPE_headerView) {
                return new HeaderViewHolder(addHeaderView);
            }
            if (TYPE_FOOTERView == viewType) {
                return new FooterViewHolder(addFooterView);
            } else {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            if (TYPE_headerView == type) {
                return;
            }
            if (TYPE_FOOTERView == type) {
                return;
            }

            if (type != TYPE_FOOTER && type != TYPE_HEADER) {
                mInternalAdapter.onBindViewHolder(holder, addHeaderView == null ? position - 1 : position - 2);
            }
        }
        ...
        if (getLayoutManager() instanceof GridLayoutManager) {
            ((GridLayoutManager) getLayoutManager()).setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                ...
                public int getSpanSize(int position) {
                    if (position == 0 || (position == 1 && addHeaderView != null) || (position == mAutoLoadAdapter.getItemCount() - 2 && addFooterView != null) || position == mAutoLoadAdapter.getItemCount() - 1) {
