 ...
 */
public class NestedScrollViewWithClick extends FrameLayout implements NestedScrollingParent,
    ...
    private ScrollerCompatWithClick mScroller;
    ...
    public NestedScrollViewWithClick(Context context) {
        this(context, null);
    }

    public NestedScrollViewWithClick(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NestedScrollViewWithClick(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initScrollView(Context context) {
        mScroller = new ScrollerCompatWithClick(context, null);
        setFocusable(true);
...
*/
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final NestedScrollViewWithClick nsvHost = (NestedScrollViewWithClick) host;
