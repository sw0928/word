...
//			paint.setTypeface(Typeface.DEFAULT_BOLD);	//加粗
            paint.setTextSize(getResources().getDimensionPixelSize(R.dimen.y20));//设置字体的大小
    ...
    private void showPopup(int item) {
        if (mPopupWindow == null) {
            ...
            mPopupText.setTextSize(getResources().getDimensionPixelSize(R.dimen.y20));
            mPopupText.setGravity(Gravity.CENTER_HORIZONTAL
                    | Gravity.CENTER_VERTICAL);

            int height = getResources().getDimensionPixelSize(R.dimen.y30);
