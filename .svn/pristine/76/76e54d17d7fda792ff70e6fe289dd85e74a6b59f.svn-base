...
class HomeLabelComponent extends  BaseComponent{
    ...
    getActivitys(){
        this.getDataByPost(1,homeurl+"activityController.api?getHomeActivitys",{parent_id:"-1"});
    }
                ...
                <div style={{display:'flex',justifyContent:'flex-end',marginTop:20,alignItems:'center'}}>
                    <Widget.Button
                        ...
                        onClick={()=>{
                            ...
                            encodeURIComponent(JSON.stringify({activity_type:"activity",parent_id:"-1",})));
                        }}>
                    ...
                    renderOperation={(rowID)=>{
                        return(
                            <div style={{display:'flex',flex:1}}>
                                ...
                                value="编辑"/>
                                <LinkComponent
                                    to={"/activity_home_activity_goods/"+this.state.activityBeans[rowID].activity_id}
                                value="子类"/>
