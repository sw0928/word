...
public class FlowIndicator extends View {
    ...
    public FlowIndicator(Context context, AttributeSet attrs) {
        ...
        space = a.getDimension(R.styleable.FlowIndicator_space, 3);
        radius = a.getDimension(R.styleable.FlowIndicator_radius, 4);
        point_normal_color = a.getColor(R.styleable.FlowIndicator_point_normal_color, getResources().getColor(R.color.RGB248_248_248));
        point_seleted_color = a.getColor(R.styleable.FlowIndicator_point_seleted_color, getResources().getColor(R.color.RGB255_255_255));
        a.recycle();
    }
